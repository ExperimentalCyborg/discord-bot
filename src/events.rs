            ...
            log_channel_id.send_message(&ctx.http,
                CreateMessage::new().embed(
                    CreateEmbed::new()
                        ...
                        .field("Global display name:", new_member.clone().user.global_name.unwrap_or(String::from("")), false)
            ...
            log_channel_id.send_message(&ctx.http,
                CreateMessage::new().embed(
                    CreateEmbed::new()
                        ...
                        .field("Discriminator:", discriminator, false)
                        .field("Global display name:", user.clone().global_name.unwrap_or(String::from("")), false)
